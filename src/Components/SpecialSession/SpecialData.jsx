 ...
 [
  {
    ...
    title:
      "Machine Learning and Deep Learning Approaches for EEG Signal Interpretation",
    organisers: [
      "Dr. Tarun Kumar, Lecturer, Government Polytechnic Kotana Baraut Baghpat, India"
    ],
    listing: "SS 001",
  },
  {
    ...
    title:
      "Internet of AI Things (IoAT) for Intelligent Networking and Autonomous Systems",
    organisers: [
      "Partha Pratim Ray, Sikkim University (Central University), Assistant Professor, Department of Computer Applications, Sikkim University, 6th Mile, PO Tadong, Gangtok, Sikkim 737102, India"
    ],
    listing: "SS 002",
  },
  {
  ...
  // },
  // {
  //   link: require("./sessions/SS-38.pdf"),
  //   title: "AI for Sustainable Smart Cities and Infrastructure",
  //   organisers: [
